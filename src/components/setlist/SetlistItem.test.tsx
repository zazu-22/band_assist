...
describe('SetlistItem', () => {
  ...
  describe('Drag States', () => {
    it('hides item when being dragged', () => {
      const { container } = render(
        <SetlistItem {...createDefaultProps({ isDragged: true })} />
      );
      const item = container.querySelector('li');
    ...
    it('is visible when not being dragged', () => {
      const { container } = render(
        <SetlistItem {...createDefaultProps({ isDragged: false })} />
      );
      const item = container.querySelector('li');
  ...
  describe('Interactions', () => {
    ...
    it('calls onDragStart when dragging begins', () => {
      ...
      const { container } = render(
        <SetlistItem {...createDefaultProps({ onDragStart })} />
      );
    ...
    it('calls onDragOver when dragging over item', () => {
      ...
      const { container } = render(
        <SetlistItem {...createDefaultProps({ onDragOver })} />
      );
    ...
    it('calls onDrop when item is dropped', () => {
      const onDrop = vi.fn();
      const { container } = render(
        <SetlistItem {...createDefaultProps({ onDrop })} />
      );
    ...
    it('calls onDragEnd when dragging ends', () => {
      ...
      const { container } = render(
        <SetlistItem {...createDefaultProps({ onDragEnd })} />
      );
