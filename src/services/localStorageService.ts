...
/**
 * LocalStorage-based persistence service
 * Stores all data in browser localStorage with Base64-encoded files
 */
export class LocalStorageService implements IStorageService {
  // Save current state to LocalStorage
  save(songs: Song[], members: BandMember[], roles: string[], events: BandEvent[]): void {
    try {
